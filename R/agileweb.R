...
#'
#' @param sites Site name string. Optionally a comma-separated list of site names. It is recommended to provide only one site name in a query, as the API is limited to 10,000 records at once (Site names are identical as listed in AirVision > Configuration Editors > Site/Parameter).
